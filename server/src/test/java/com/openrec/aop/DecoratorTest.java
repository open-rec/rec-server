...
public class DecoratorTest {
    public String endpoint(JsonReq<String> request) {
        return request.getBody();
    }

    @Test
    public void apiDecoratorProceedsAndUsesRequestId() throws Throwable {
    ...
    @Test
    public void methodTimerReturnsJoinPointValue() throws Throwable {
        ProceedingJoinPoint point = mock(ProceedingJoinPoint.class);
